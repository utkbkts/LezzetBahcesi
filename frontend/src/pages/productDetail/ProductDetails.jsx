        ...
        <div className="flex flex-col mt-12 p-6   rounded-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <button className="w-8 h-8 bg-gray-100 text-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
                -
              </button>
            ...
            <button className="mt-4 py-2 px-6 bg-blue-600 text-white font-bold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
              Sepete Ekle
            </button>
            <div className="space-y-2">
              ...
              <div className="text-gray-600">
                Değerlendirme Puanı:{" "}
                <span className="font-semibold">{data?.product?.ratings}</span>{" "}
                |{" "}
